...
import FlorinaRobot.modules.sql.notes_sql as sql
from FlorinaRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from FlorinaRobot.__main__ import DATA_IMPORT
from FlorinaRobot.modules.helper_funcs.chat_status import user_admin
from FlorinaRobot.modules.helper_funcs.alternate import typing_action

# from FlorinaRobot.modules.rules import get_rules
import FlorinaRobot.modules.sql.rules_sql as rulessql

# from FlorinaRobot.modules.sql import warns_sql as warnssql
import FlorinaRobot.modules.sql.blacklist_sql as blacklistsql
from FlorinaRobot.modules.sql import disable_sql as disabledsql

# from FlorinaRobot.modules.sql import cust_filters_sql as filtersql
# import FlorinaRobot.modules.sql.welcome_sql as welcsql
import FlorinaRobot.modules.sql.locks_sql as locksql
from FlorinaRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("FlorinaRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("FlorinaRobot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `FlorinaRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("FlorinaRobot{}.backup".format(chat_id))  # Cleaning file
