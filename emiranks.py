...
from FlorinaRobot import (DEV_USERS, OWNER_ID, DRAGONS, SUPPORT_CHAT, DEMONS,
                          TIGERS, WOLVES, dispatcher)
from FlorinaRobot.modules.helper_funcs.chat_status import (dev_plus, sudo_plus,
                                                           whitelist_plus)
...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(),
                                   'EmiliaAnimeBot/elevated_users.json')
...
dispatcher.add_handler(SUPREMEDEMONS_HANDLER)
...
__handlers__ = [
    ...
    DEMONRACE_HANDLER, WARCOMMANDERS_HANDLER, COMMANDMENTS_HANDLER, PARADISE_HANDLER, SUPREMEDEMONS_HANDLER
]
